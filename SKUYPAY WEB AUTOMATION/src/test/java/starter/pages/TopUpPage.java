...
public class TopUpPage extends PageObject {
    ...
    private By topup() {
        return By.xpath("//a[@href=\"/admin/layanan/topup\"]");
    }
    private By tambahbank() {
        return By.xpath("//button[@class=\"btn btn-primary\"]");
    }

    private By kodeBankfield() {
        return By.xpath("(//input[@type='text'])[1]");
    }

    private By namaBankfield() {
    ...
    private By pagetopupkembali() { return By.xpath("//h1[contains(text(),'Top Up')]");}
    ...
    @Step
    public void kliktopup() throws InterruptedException {
        $(topup()).click();
        Thread.sleep(1500);
    }
    @Step
    public void kliktambahbank() throws InterruptedException{
        $(tambahbank()).click();
        Thread.sleep(1500);
    }

    @Step
    public void inputfieldkodebank(String kode) throws InterruptedException {
        $(kodeBankfield()).click();
        $(kodeBankfield()).type(kode);
        Thread.sleep(1500);
    }

    @Step
    public void inputfieldnamabank(String namajenis) throws InterruptedException {
        $(namaBankfield()).click();
        $(namaBankfield()).type(namajenis);
        Thread.sleep(1500);
    }
    ...
    @Step
    public void kembalikehalamantopup() throws InterruptedException {
        $(pagetopupkembali()).shouldBeVisible();
        Thread.sleep(1500);
    }
}
