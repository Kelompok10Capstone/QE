...
public class PromoPage extends PageObject {
    ...
    private By promo() {
        return By.xpath("//a[@href=\"/admin/layanan/promo\"]");
    }
    private By tambahpromo() {
        return By.xpath("//button[@class=\"btn btn-primary\"]");
    }

    private By kodepromo() {
    ...
    private By uploadgambar() {
        return By.xpath("//input[@name='image']");
    }
    private By nominalfield() {
    ...
    private By pagepromokembali() { return By.xpath("//h1[contains(text(),'Promo')]");}
    ...
    @Step
    public void klikpromo() throws InterruptedException {
        $(promo()).click();
        Thread.sleep(1500);
    }
    @Step
    public void kliktambahpromo() throws InterruptedException{
        $(tambahpromo()).click();
        Thread.sleep(1500);
    }

    @Step
    public void inputfieldkodepromo(String kode) throws InterruptedException {
        $(kodepromo()).click();
        $(kodepromo()).type(kode);
        Thread.sleep(1500);
    }
    ...
    @Step
    public void inputfielddeskripsi(String description) throws InterruptedException {
        $(deskripsi()).click();
    ...
    @Step
    public void inputgambar() throws InterruptedException {
        $(uploadgambar()).sendKeys("C:/Dev/CapstoneProjectBaru/WhatsApp Image 2023-06-23 at 21.13.52.jpeg");
        Thread.sleep(1500);
    }
    @Step
    public void inputnominal(String nominal) throws InterruptedException {
        $(nominalfield()).click();
        $(nominalfield()).type(nominal);
        Thread.sleep(1500);
    }
    ...
    @Step
    public void kembalikehalamanpromo() throws InterruptedException {
        $(pagepromokembali()).shouldBeVisible();
        Thread.sleep(1500);
    }
}
